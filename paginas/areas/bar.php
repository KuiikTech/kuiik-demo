...
?>
      ...
      <div class="container-fluid" data-layout="container">
        <nav class="navbar navbar-dark navbar-vertical navbar-inverted">
          <div class="d-flex align-items-center">
            <a class="navbar-brand" href="javascript:$('#div_contenido').load('cuadros_pedidos.php/?area=Bar');">
        ...
        <div class="content" style="margin-left: 1rem !important">
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            <a class="navbar-brand me-1 me-sm-3" href="javascript:$('#div_contenido').load('cuadros_pedidos.php/?area=Bar');">
              <div class="d-flex align-items-center">
  ...
  <script type="text/javascript">
    ...
    //$('#div_lateral').load('reservas.php/?area=Bar');
    ...
    var intervalo_pedidos = setInterval("cambios('Bar')", 30000);
      ...
      $.ajax({
        ...
        success: function(r) {
          ...
          if (datos['consulta'] == 1) {
            ...
            intervalo_pedidos = setInterval("cambios('Bar')", 30000);
          } else {
    ...
    function cargar_div(codigo, orden) {
      $('#div_card_' + codigo).load('cuadro_pedido.php/?cod_pedido=' + codigo + '&orden=' + orden + '&area=Bar');
    }
    ...
    function cargar_div_reserva(codigo, orden) {
      $('#div_card_reserva_' + codigo).load('cuadro_reserva.php/?cod_reserva=' + codigo + '&orden=' + orden + '&area=Bar');
    }
