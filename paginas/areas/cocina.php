...
?>
  ...
  <head>
    ...
    <title>Restaurante | W-POS | Kuiik</title>
    ...
    <link href="../../assets/css/propios.css" rel="stylesheet" id="owm-style-default">
  </head>
                  ...
                  <div class="position-relative m-4 mt-0">
                    ...
                    <div class="divider-content-center">
                      <div class="theme-control-toggle fa-icon-wait px-5">
                        <input class="form-check-input ms-0 theme-control-toggle-input" id="themeControlToggleLogin" type="checkbox" data-theme-control="theme" value="dark" />
                        <label class="mb-0 theme-control-toggle-label theme-control-toggle-light" for="themeControlToggleLogin" data-bs-toggle="tooltip" data-bs-placement="left" title="Cambiar a tema claro"><span class="fas fa-sun fs-0"></span></label>
                        <label class="mb-0 theme-control-toggle-label theme-control-toggle-dark" for="themeControlToggleLogin" data-bs-toggle="tooltip" data-bs-placement="left" title="Cambiar a tema oscuro"><span class="fas fa-moon fs-0"></span></label>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <script type="text/javascript">
    ...
    var intervalo_pedidos = setInterval("cambios('Cocina')", 30000);
    ...
    function cargar_div(codigo, orden) {
      $('#div_card_' + codigo).load('cuadro_pedido.php/?cod_pedido=' + codigo + '&orden=' + orden + '&area=Cocina');
    }
    ...
    function cargar_div_reserva(codigo, orden) {
      $('#div_card_reserva_' + codigo).load('cuadro_reserva.php/?cod_reserva=' + codigo + '&orden=' + orden + '&area=Cocina');
    }
