...
if(isset($_SESSION['usuario_restaurante']))
{
		...
		<div class="card-body p-2">
			<div class="row">
				<div class="col text-right">
					<button class="btn btn-sm btn-outline-primary ml-auto btn-round" data-bs-toggle="modal" data-bs-target="#Modal_Nuevo_Cliente">
	...
	<script type="text/javascript">
		$(document).ready(function()
		{
			...
			$('#div_tabla_clientes').load('tablas/clientes.php', function(){cerrar_loader();});
		});
		...
		$('#btn_buscar_cliente').click(function()
		{
			...
			if(input_busqueda != '' && input_busqueda.length>2)
				$('#div_tabla_clientes').load('tablas/clientes.php/?input_buscar='+input_busqueda, function(){cerrar_loader();});
			else
			{
			...
			$.ajax({
				...
				success:function(r)
				{
					...
					if(datos['consulta'] == 1)
					{
						...
						w_alert({ titulo: 'Cliente Agregado Correctamente', tipo: 'success' });
			...
			$.ajax({
				...
				success:function(r)
				{
					...
					if(datos['consulta'] == 1)
					{
						...
						w_alert({ titulo: 'Cliente Actualizado Correctamente', tipo: 'success' });
						$("#btn_buscar_cliente").click();
		...
		$('#btnEliminar').click(function()
		{
			...
			$.ajax({
				...
				success:function(r)
				{
					...
					if(datos['consulta'] == 1)
					{
						w_alert({ titulo: 'Cliente Eliminado Correctamente', tipo: 'success' });
						$("#btn_buscar_cliente").click();
