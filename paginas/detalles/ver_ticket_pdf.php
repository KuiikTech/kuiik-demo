...
<div class="modal-body">
	<iframe src="<?php echo $ruta ?>?nocache=<?php echo time(); ?>" onload="isLoaded()" type="application/pdf" width="100%" height="700px" id="objeto_pdf" name="objeto_pdf">
...
{ 
	...
	<script type="text/javascript">
		...
		function isLoaded()
		{
			var pdfFrame = window.frames["objeto_pdf"];
			pdfFrame.focus();
			pdfFrame.print();
		}
	</script>
